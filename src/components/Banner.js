            ...
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Rethabile Diale`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Web Developer", "Software Engineer" ]'><span className="wrap">{text}</span></span></h1>
                  <p>A passionate full-stack junior software engineer seeking a role to apply my skills in React, JavaScript, and back-end technologies to develop high-quality, scalable software solutions. Eager to contribute to engineering efforts by building seamless, user-focused applications across the entire stack.</p>
